        ...
        function Element(config, currentStep, template, loadTemplateFn, hasReachedEndFn, goToNextFn,
            ...
            if (config.elementTemplate) {
                ...
                this.popoverTemplate =
                    '<div class=\"row\">' +
                    '<div class=\"col-xs-12\"><a class=\"skipBtn pull-left\" type=\"button\"><span class=\"iconfont icon-close\"></span></a></div>' +
                    '<div class=\"col-xs-12\">' +
                    this.content +
                    '</div>' +
                    '</div>' +
                    ...
                    '<div class=\"pull-left\">' +
                    '<button id=\"prevBtn\" class=\"prevBtn btn\" type=\"button\">הקודם</button>' +
                    ' <button style=\"' +
                    'display:' + _generateStyleCambium() +
                     '\" id=\"nextBtn\" class=\"nextBtn btn btn-primary\" type=\"button\">' +
            ...
            function _generateStyleCambium() {
                if (isEnd) {
                    return 'inline-block;width: auto;'
                } else {
                    return 'none;'
                }
            }
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                function dropCurtain(shouldDrop) {
                    ...
                    if (shouldDrop) {
                        if ($fkEl.size() === 0) {
                            $('.wrap-page-list').append('<div id="ng-curtain" class="' + globalHardcodedCurtainClass + '"></div>');
                            $fkEl = $('#ng-curtain');
                            $fkEl.slideDown(10);
                        }
                    } else {
